...
http_df = pd.read_csv(r"C:\Users\hanghang\Desktop\ssh_test1\ssh_http.csv",header=None)
#print http_df
http_df = http_df[http_df > 0] 
#print http_df
# .drop(labels, axis=0)  去掉行或者列
# 去掉包含缺失值的行：
http_df = http_df.dropna(how='any')
#print http_df.shape[0]


login_df = pd.read_csv(r"C:\Users\hanghang\Desktop\ssh_test1\ssh_login.csv",header=None)
...
x_col = [x for x in res_df.columns if x != 24]
X = res_df[x_col]
# print X
Y = res_df[24]
# print Y
...
model = xgb.train(params,train,num_rounds)
model.save_model(r"C:\Users\hanghang\Desktop\ssh_test1\ssh1.model")
